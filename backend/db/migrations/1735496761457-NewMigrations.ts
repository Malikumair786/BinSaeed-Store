...
export class NewMigrations1735496761457 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`phoneNo\` \`phoneNo\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`phoneNo\` \`phoneNo\` varchar(255) NOT NULL`);
    }
